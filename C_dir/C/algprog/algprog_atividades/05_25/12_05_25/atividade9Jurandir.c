...
int main(){
  ...
  int vetor[8],
  tamVetor = sizeof(vetor) / sizeof(vetor[0]);
  ...
  int vetorPares[pares],
  tamPares = sizeof(vetorPares) / sizeof(vetorPares[0]);

  int vetorImpares[impares],
  tamImpares = sizeof(vetorImpares) / sizeof(vetorImpares[0]);
